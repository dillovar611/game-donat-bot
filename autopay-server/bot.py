...
async def giveaway_info(call: CallbackQuery):
    ...
    await _safe_edit(
        call,
        "🎁 <b>Тӯҳфаи ройгон — лотереяи мағоза</b>\n\n"
...
_FAQ_ITEMS = [
    ...
    ("🎁 Тӯҳфаи ройгон чист?",
     "Ҳар як фармоиши шумо шуморо худкор ба қуръакашии тӯҳфаи ройгон дохил "
     "мекунад! Аз байни харидорони охирин, як нафар тасодуфан интихоб "
     "мешавад ва тӯҳфаро БЕПУЛ мегирад — ҳеҷ амали иловагӣ лозим нест, "
     "фақат харид кунед."),
]
