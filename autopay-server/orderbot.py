...
маблағи воқеӣ ҳељ дастрасӣ надорад.
...
_FAQ = [
    ...
    (("номери дс", "номер дс", "номери душанбе", "номери дускан",
     ...
     "3️⃣ Рақамро нусха бардоред ва аз <b>ҳар банк/илова</b> маблағ фиристед — "
...
# то диски сервер пур нашавад. Бо ~2000 фармоиш/рӯз ва квотаи ~6ГБ, ҳар рӯз
# ~0.8ГБ расм ҷамъ мешавад — пас 2 рӯз нигоҳ доштан бехатар аст (матни
# сӯҳбатҳо ҳамеша мемонанд, танҳо РАСМҲО нест мешаванд).
CHAT_MEDIA_KEEP_DAYS = 2
