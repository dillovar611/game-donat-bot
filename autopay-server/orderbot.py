...
_FAQ = [
    ...
    (("бехатар", "кафолат", "боварнок", "надёжн", "кидалов",
      "точно приде", "не обман", "гарантия", "обманете", "кинете"),
     "✅ <b>100% бехатар!</b> Мо ҳазорон фармоишро иҷро кардем. Пас аз "
     "пардохт алмосҳо ХУДКОР ва фавран мерасанд. Агар ягон мушкил шавад — "
     "ҳамин ҷо нависед, мо ҳатман ҳал мекунем 🙏💎"),
    ...
    (("усули пардохт", "чи хел пардохт", "чӣ хел пардохт", "как оплатит",
     ...
     f"Ҳамаашро дар {SHOP_BOT_USERNAME} мебинед — интихоб кунед ва фавран "
     "пардохт кунед 😊"),
    # Чӣ хел харид кунам
    (("чи хел харид", "чӣ хел харид", "как купить", "чи тавр харид",
     ...
     "→ ID-и худро нависед → пардохт кунед. Алмосҳо ХУДКОР мерасанд! 💎⚡"),
    # ID-и Free Fire чист / аз куҷо
    (("ид чист", "айди чист", " id чист", "аз куҷо ид", "ид куҷо",
      "player id", "плеер ид", "айди аз кучо", "ид худро аз кучо"),
     "🆔 ID-и Free Fire дар худи бозӣ, дар профили шумо навишта шудааст "
    ...
    (("реферал", "бонус", "дӯстамро", "дустамро даъват", "пригласи",
      "реф систем", "балансам", "баланси ман"),
     "🤝 Бале! Дӯстонатонро даъват кунед — аз ҳар харидашон ба балансатон "
     f"бонус меафтад. Тафсилот дар {SHOP_BOT_USERNAME} (бахши «Баланс/Реферал») 💰"),
]
